      ...
      {page === 1 ? (
        ...
        <>
          <section className="address-card information-page">
            ...
            <img className="information-photo" src="/manus-storage/mannuella-segunda-pagina-outpainting-horizontal_33dc906b.png" alt="Mannuella como fadinha em um Jardim Encantado" />
